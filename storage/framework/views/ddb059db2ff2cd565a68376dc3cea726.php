...
unset($__errorArgs, $__bag); ?>" type="text" name="firstName" id="firstName" value="<?php echo e(old('firstName', $employee->firstName)); ?>" placeholder="Enter First Name">
...
unset($__errorArgs, $__bag); ?>" type="email" name="email" id="email" value="<?php echo e(old('email', $employee->email)); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" type="number" name="age" id="age" value="<?php echo e(old('age', $employee->age)); ?>" placeholder="Enter Age">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\Tugas Kuliah Semester 3\Pengembangan Aplikasi Website\Praktikum Laravel\Modul_13\resources\views/employees/edit.blade.php ENDPATH**/ ?>