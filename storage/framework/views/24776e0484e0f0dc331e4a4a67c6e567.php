        ...
        <form action="<?php echo e(route('employees.store')); ?>" method="POST">
            ...
            <div class="row justify-content-center">
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <!-- Menghapus bagian ini untuk menghilangkan error yang tampil di atas -->
                    <!-- <?php if($errors->any()): ?>
...
<?php /**PATH C:\Tugas Kuliah Semester 3\Pengembangan Aplikasi Website\Praktikum Laravel\Modul_13\resources\views/employee/create.blade.php ENDPATH**/ ?>